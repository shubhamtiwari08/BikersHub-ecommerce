...
function Landing() {
  ...
  const images = ["https://c4.wallpaperflare.com/wallpaper/216/900/913/motorcycles-other-wallpaper-preview.jpg",
...
return (
    <div className='landing-main-container'  >
      <div className='title-container'>
        <div>    
        <div className='hero-title'><h1>LOOKING <br/> FOR <br/> <span className="bike-part">BIKE PARTS?</span></h1>
        <h2>Don't worry ! <br/> we got you  <br/>  <span className="covered">covered.</span> </h2></div>
        <div className="carousel-bikes">
        <Carousel showArrows={false} showStatus={false} transitionTime={1000}  interval={5000} showThumbs={false} infiniteLoop={true} autoPlay={true} >
          {images.map((image,index)=> (<div key={index}><img src={image} alt="bike-img" style={{height:"50rem",objectFit:"cover"}}  /></div>))}
        </Carousel>
        </div>
        </div>
      <button className='Shop-now button' onClick={()=>Navigate('/productpage')}>SHOP NOW</button>
      </div>
